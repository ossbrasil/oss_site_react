    ...
    const cards = [
        {
            ...
            title: "Rastreamento",
            description: "Acompanhamos a localização de cada veículo com precisão através de GPS, facilitando a coordenação e garantindo uma resposta rápida a incidentes. Com essas informações valiosas, é possível direcionar motoristas para serviços de forma ágil e eficaz."
        },
        {
        ...
        },
        {
            ...
            title: "Manutenção",
            description: "Indicamos através de checklists obtidos, manutenções preventivas de acordo com cada veículo indiviualmente, facilitando e evitando transtornos e manutenções corretivas."
        }
    ];
                        ...
                        <div className="max-w-md">
                            <div className="relative pl-6">
                                ...
                                <p className="text-white text-base leading-relaxed">
                                    O Sistema SIG está em constante aprimoramento para incorporar as mais
                                    novas tecnologias do mercado. Assim, garantimos eficiência e inovação
                                    aliada a uma gestão moderna e eficaz.
                                </p>
                            </div>
                        </div>
                    </div>
