export const DifferentialsPage = () => {
    const services = [
        ...
        },
        {
            ...
            description: "Suporte direto com a equipe interna de desenvolvimento para ter clareza e velocidade no progresso de novos módulos."
        },
        {
            icon: "/assets/analise.png",
            title: "Análise de Dados",
            description: "Processamento em tempo real para otimizar a eficiência operacional e aprimorar a gestão."
        }
    ];
